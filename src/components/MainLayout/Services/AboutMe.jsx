    ...
    <div className="p-4">
      <div className="flex flex-col md:flex-row justify-between items-center pt-2 text-neutral-300">
        ...
        <div className="text-lg md:text-xl mb-4 md:mb-0">
          ...
          full-stack development, specializing in the MERN stack. I enjoy
          building user-friendly applications and solving technical challenges,
          constantly seeking opportunities to grow and refine my skills. Outside
          of coding, I’m deeply involved in various extracurricular activities
          such as
          <span className="text-cust-red font-semibold"> music</span>,
          <span className="text-cust-red font-semibold"> sports</span>, and
          <span className="text-cust-red font-semibold"> video editing</span>,
